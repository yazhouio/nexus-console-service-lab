...
export const extensionDemoRoutes = {
  'extension-demo-route': {
    id: 'extension-demo-route',
    path: '/extensions',
...
export const extensionDemoNavigation = {
  'extension-demo-navigation': primaryNavigation({
    id: 'extension-demo-navigation',
    label: 'Extension points',
    routeId: 'extension-demo-route',
    group: 'secondary',
    order: 800,
  }),
...
export const extensionDemoExtensions = {
  'extension-demo-home-card': homeCard({
    id: 'extension-demo-home-card',
    label: 'Extension Demo',
    surfaceId: 'extension-demo-card',
    order: 10,
    initiallySelected: false,
  }),
  'extension-demo-settings-section': settingsSection({
    id: 'extension-demo-settings-section',
    label: 'Demo preferences',
    surfaceId: 'extension-demo-settings',
    order: 10,
  }),
  'extension-demo-plugin-action': {
    id: 'extension-demo-plugin-action',
    kind: 'action',
    actionId: 'plugin-contract-check',
    label: 'Check extension contract',
    point: PLUGIN_DETAILS_ACTIONS_POINT,
    order: 50,
    group: 'secondary',
    expectedProfile: 'detail.actions@1',
    expectedRefContract: 'console-core.plugin-ref@1',
  },
  'extension-demo-node-action': {
    id: 'extension-demo-node-action',
    kind: 'action',
    actionId: 'node-health-check',
  ...
  'extension-demo-node-health-tab': {
    id: 'extension-demo-node-health-tab',
    kind: 'tab',
    tabId: 'health',
    label: 'Health',
    surfaceId: 'extension-demo-node-health',
    point: NODE_TABS_POINT,
    order: -50,
    expectedProfile: 'detail.tabs@1',
    expectedRefContract: 'cluster.resource-ref@1',
  },

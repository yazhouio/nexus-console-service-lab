...
function NodeHealthTab() {
  ...
  const nodeName = itemRef && typeof itemRef === 'object' && !Array.isArray(itemRef) && 'name' in itemRef && typeof itemRef.name === 'string' ? itemRef.name : 'node';
  return <article className="extension-demo-el-article extension-demo-node-health">
    ...
    <p className="extension-demo-el-p">Demo tab mounted for <code className="extension-demo-el-code">{nodeName}</code> through the typed ResourceRef context.</p>

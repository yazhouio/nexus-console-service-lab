...
export const distribution: BrowserDistribution = {
  ...
  capabilityGrants: { 'console-core': ['routes.query','routes.navigate','plugins.query','plugins.manage','diagnostics.query','diagnostics.export','audit.query'], cluster: ['routes.query','routes.navigate'], deployment: ['routes.navigate'] },

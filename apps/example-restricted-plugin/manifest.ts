  ...
  contributions: {
    ...
    extensions: [
      ...
      },
      {
        id: 'kubeeye-unused',
        kind: 'surface',
        point: { ownerPluginId: 'console-core', id: 'unavailable', contractMajor: 1 },
        surfaceId: 'overview',
      },
    ],
    navigation: [
      {
        ...
        point: PRIMARY_NAVIGATION_POINT,
        label: 'KubeEye',
...
export const kubeeyeManifestV2 = {
  ...kubeeyeManifest,
  version: '2.0.0',
  entry: '/plugins/kubeeye/2.0.0/',
  contributions: {
    ...kubeeyeManifest.contributions,
    routes: [
      ...(kubeeyeManifest.contributions.routes ?? []),
      {
        id: 'node-alert-messages',
        parentRouteId: 'node-detail',
        point: NODE_CHILD_ROUTES_POINT,
        path: 'alert-messages',
        surfaceId: 'overview',
        initialParameters: { view: 'node-alerts' },
      },
    ],
    navigation: [
      ...(kubeeyeManifest.contributions.navigation ?? []),
      {
        id: 'node-alert-navigation',
        label: 'Alerts',

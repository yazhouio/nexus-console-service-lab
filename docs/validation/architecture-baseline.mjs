...
export function restoreArchitectureBaseline(root, scratch) {
  const paths = ['packages/plugin-runtime/src', 'packages/plugin-runtime/test', 'apps/host/src', 'apps/host/test'];
  const archive = execFileSync('git', ['archive', architectureBaseline, '--', ...paths], { cwd: root, maxBuffer: 16 * 1024 * 1024 });

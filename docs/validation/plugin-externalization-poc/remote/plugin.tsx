...
export const identities = {
  ...
  jsx: jsx.jsx,
  UiProvider: sdk.UiProvider,
  useUiClient: sdk.useUiClient,
  RoutePresentationProvider: sdk.RoutePresentationProvider,
...
function View() {
  ...
  return (
    <section className={classes.card} data-probe="main">
      <span data-client>{typeof client.mountSlot}</span>
      <span data-route>{route.params.id}</span>
      <sdk.RouteLink routeId="poc-route" params={{ id: 'linked' }}>
        Host link
      </sdk.RouteLink>
      <sdk.RouteOutlet />
